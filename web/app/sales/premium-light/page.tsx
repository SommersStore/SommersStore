...
export default function SalesPagePremiumLight() {
    ...
    return (
        <div className="min-h-screen bg-[#fcf9f6] text-[#3e342b] font-sans selection:bg-emerald-100 selection:text-emerald-900">
            ...
            {/* 1. HERO - Reestruturado para Elegância e Elite */}
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image src="/sales/assets/capa-curso-principal-01_1280x720.png" alt="Hero background" fill className="object-cover opacity-25" priority />
                    <div className="absolute inset-0 bg-gradient-to-b from-[#fcf9f6]/30 via-[#fcf9f6]/95 to-[#fcf9f6]" />
                </div>
                <div className="relative z-10 container mx-auto px-6 text-center max-w-5xl">
                    <div className="inline-block px-6 py-2 rounded-full bg-white text-emerald-800 text-[10px] font-black mb-10 tracking-[0.4em] uppercase border border-emerald-100 shadow-sm">
                        O Despertar da Alquimia Brasileira
                    </div>
                    <h1 className="text-4xl md:text-8xl font-serif font-black text-[#2d241e] mb-8 leading-[1.05] tracking-tight drop-shadow-sm">
                        Domine a Alquimia dos <span className="text-emerald-700 italic border-b-4 border-emerald-100 pb-2">Sentidos</span> e Mude sua Vida
                    </h1>
                    <p className="text-lg md:text-2xl text-[#6b5847] mb-14 max-w-3xl mx-auto leading-relaxed font-serif italic">
                        Descubra o segredo para transformar ingredientes simples em rituais que encantam, curam e constroem um negócio lucrativo com baixo investimento.
                    </p>
                    <div className="max-w-2xl mx-auto rounded-[4rem] overflow-hidden shadow-2xl shadow-emerald-900/10 mb-12 border-[12px] border-white relative group">
                        <div className="absolute inset-0 bg-emerald-900/5 opacity-0 group-hover:opacity-100 transition-opacity z-10" />
                        <Image src="/sales/assets/ChatGPT Image 5 de fev. de 2026, 22_43_39.png" alt="Alquimia Elite" width={800} height={500} className="object-cover group-hover:scale-105 transition-transform duration-1000" />
                    </div>
                    <button onClick={() => document.getElementById('offer')?.scrollIntoView({ behavior: 'smooth' })} className="px-14 py-7 rounded-[2.5rem] bg-[#2d241e] text-[#fcf9f6] font-black text-xl hover:bg-emerald-800 hover:scale-[1.05] transition-all shadow-2xl shadow-emerald-900/20 uppercase tracking-widest">
                        QUERO INICIAR MINHA JORNADA DE ELITE
                    </button>
                </div>
            </section>

            {/* 2. PAIN/DOR - Conexão Emocional Profunda */}
            ...
            {/* 3 & 4. SOLUTION - A Autoridade do Método */}
            ...
            {/* 5 & 7. REALITY / BENEFITS - O Objeto do Desejo */}
                ...
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    ...
                    <div className="space-y-6">
                        {lessons.map((lesson, i) => (
                            <div key={i} className="flex flex-col md:flex-row items-center gap-8 p-10 rounded-[3rem] bg-white shadow-xl border border-[#f0ede9] hover:bg-emerald-50/30 transition-all text-left">
            ...
            {/* 9. PRICING/OFFER - Call to Action de Russell Brunson Clone */}
            <section id="offer" className="py-32 bg-[#fcf9f6] relative">
                <div className="container mx-auto px-6 relative z-10 max-w-5xl">
                    <div className="bg-white rounded-[6rem] p-12 md:p-32 text-[#2d241e] text-center shadow-[0_60px_120px_rgba(16,185,129,0.15)] border border-[#f0ede9] relative">
                        ...
                        <div className="flex flex-col items-center gap-4 mb-20 bg-emerald-50/30 py-16 rounded-[4rem] border border-emerald-100/50">
                            <span className="text-[#a89686] line-through text-3xl italic font-serif opacity-50">De R$ 197,00 por apenas</span>
                            <div className="flex items-baseline gap-3 group transition-transform duration-500 hover:scale-110">
                                <span className="text-4xl font-black text-emerald-800">R$</span>
                                <span className="text-[130px] md:text-[220px] font-serif font-black text-emerald-700 tracking-tighter leading-none">47</span>
            ...
            <section className="py-32 bg-[#f4f1ee]">
                <div className="container mx-auto px-6 text-center max-w-5xl bg-white p-20 md:p-32 rounded-[6rem] shadow-2xl border border-[#f0ede9] relative overflow-hidden">
                    <div className="absolute top-[-50px] left-[-50px] w-80 h-80 bg-emerald-50 rounded-full blur-[90px] opacity-40" />
            ...
            {/* 12. FAQ - Remoção de Objeções Claras */}
            <section className="py-32 bg-white">
                <div className="container mx-auto px-6 max-w-3xl">
                    <h2 className="text-5xl font-serif text-center mb-24 text-[#2d241e] tracking-tight italic">Dúvidas Frequentes</h2>
                    <div className="space-y-12">
                        {faqData.map((faq, i) => (
                            <div key={i} className="group border-b-2 border-[#fcf9f6] pb-12 transition-all hover:bg-[#fcf9f6]/30 px-6 rounded-3xl">
            ...
            {/* 13. FOOTER/CTA - O Selo de Luxo Final */}
            <footer className="py-32 border-t border-[#f0ede9] bg-[#fcf9f6] text-center relative">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 text-[#a89686] text-[11px] font-black uppercase tracking-[0.5em] border-t border-[#e8dad0] pt-16">
                        <span className="hover:text-emerald-800 transition-colors cursor-pointer">Sommers Store © 2026</span>
                        <span className="hover:text-emerald-800 transition-colors cursor-pointer">Termos de Luxo & Uso</span>
                        <span className="hover:text-emerald-800 transition-colors cursor-pointer">Privacidade dos Sentidos</span>
                    </div>
                </div>
            </footer>
        </div>
