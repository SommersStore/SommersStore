# Expert Heuristics: Brazilian Marketing Specialists

Este documento adapta as melhores práticas do mercado brasileiro para a realidade da SommersStore.

## 1. Érico Rocha (Lançamentos e Gatilhos)
- **Fórmula de Lançamento (PLF)**: Use a sequência CPL1 (Oportunidade), CPL2 (Transformação), CPL3 (O Evento) antes de abrir o carrinho.
- **Gatilho da Antecipação**: Crie o desejo pelo produto semanas antes dele estar disponível.
- **Gatilho do Evento**: Transforme a venda em um acontecimento, algo que as pessoas não querem "ficar de fora".
