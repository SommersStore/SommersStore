# Skill Playbook: SKL-EXP-06 - AssetDirection

## Objetivo Operacional
Executar AssetDirection com criterio operacional no fases BLD-08, garantindo as saidas `DLV-ASSET-BibliotecaVisualHD`.
