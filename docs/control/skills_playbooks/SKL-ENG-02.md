# Skill Playbook: SKL-ENG-02 - DeployPipeline

## Objetivo Operacional
Executar DeployPipeline com criterio operacional no fases BLD-12, garantindo as saidas `DLV-DEPLOY-URLPublicada`, `DLV-DEPLOY-DNS`, `DLV-DEPLOY-AmbienteAtivo`.
