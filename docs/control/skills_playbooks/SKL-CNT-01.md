# Skill Playbook: SKL-CNT-01 - EditorialStructuring

## Objetivo Operacional
Executar EditorialStructuring com criterio operacional no fases BLD-04, garantindo as saidas `DLV-BLUEPRINT-SkeletonEditorial`, `DLV-SPEC-Capitulos`, `DLV-SPEC-Secoes`.
