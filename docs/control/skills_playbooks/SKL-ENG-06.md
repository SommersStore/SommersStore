# Skill Playbook: SKL-ENG-06 - DataSync

## Objetivo Operacional
Executar DataSync com criterio operacional no fases BLD-13 e operacao OPS-07, garantindo as saidas `DLV-AUTOMATION-Emails`, `DLV-AUTOMATION-Webhooks`, `DLV-AUTOMATION-EntregaDigital`.
...
- Operacao: `OPS-07` (Payment Process)
- Gatilhos principais: `conclusao de BLD-11`, `conclusao de BLD-12`, `submissão do pedido`

## Entradas
- Build: `BLD-11`, `BLD-12`
- Operacao: `dados do pedido`

## Saidas Esperadas
- Build: `DLV-AUTOMATION-Emails`, `DLV-AUTOMATION-Webhooks`, `DLV-AUTOMATION-EntregaDigital`
- Operacao: `payment status`
...
- ALT-OPS-03: Pagamento recusado em alta [high] owner=SQD-ENG

## Fallback e Incidentes
- Acao de fallback: Rerun de integração / entrega | verificar gateway / sync
