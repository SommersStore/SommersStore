# Skill Playbook: SKL-ENG-03 - WebhookAutomation

## Objetivo Operacional
Executar WebhookAutomation com criterio operacional no fases BLD-13, garantindo as saidas `DLV-AUTOMATION-Emails`, `DLV-AUTOMATION-Webhooks`, `DLV-AUTOMATION-EntregaDigital`.
...
- Gatilhos principais: `conclusao de BLD-11`, `conclusao de BLD-12`
...
- Acao de fallback: Rerun de integração / entrega
