# Skill Playbook: SKL-CORE-02 - ProductPositioning

## Objetivo Operacional
Executar ProductPositioning com criterio operacional no fases BLD-01, garantindo as saidas `DLV-BLUEPRINT-ProductBrief`, `DLV-SPEC-OfferThesis`, `DLV-SPEC-PersonaPreliminar`.

## Donos
- Grupo: `CORE`
- Squads: SQD-CORE - CORE STRATEGY
- Agentes: `@aiox-master`, `@pm`
