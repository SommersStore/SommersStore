# Skill Playbook: SKL-MKF-01 - MarketIntelligence

## Objetivo Operacional
Executar MarketIntelligence com criterio operacional no fases BLD-02, garantindo as saidas `DLV-ASSET-ReferenceBoard`, `DLV-REPORT-BenchmarkDeck`, `DLV-INSIGHT-LinguagemMercado`.
