# Skill Playbook: SKL-MKF-02 - CompetitorDeconstruction

## Objetivo Operacional
Executar CompetitorDeconstruction com criterio operacional no fases BLD-02, garantindo as saidas `DLV-ASSET-ReferenceBoard`, `DLV-REPORT-BenchmarkDeck`, `DLV-INSIGHT-LinguagemMercado`.
