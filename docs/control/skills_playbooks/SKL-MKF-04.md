# Skill Playbook: SKL-MKF-04 - FunnelArchitecture

## Objetivo Operacional
Executar FunnelArchitecture com criterio operacional no fases BLD-03, garantindo as saidas `DLV-BLUEPRINT-Roadmap`, `DLV-BLUEPRINT-FunnelBlueprint`, `DLV-SPEC-Backlog`.
