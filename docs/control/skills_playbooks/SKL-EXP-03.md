# Skill Playbook: SKL-EXP-03 - A4Composition

## Objetivo Operacional
Executar A4Composition com criterio operacional no fases BLD-07, garantindo as saidas `DLV-SPEC-MDS`, `DLV-ASSET-LayoutA4`, `DLV-SPEC-Grid`.
