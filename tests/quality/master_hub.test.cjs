...
function testIntegrationPoints() {
  ...
  for (const tab of ['planilha', 'dividas', 'investimentos']) {
  ...
  assert.match(dashboardHtml, /const availableTabs = \['planilha','dividas','investimentos'\];/, 'Financas tab navigation should include Investimentos');
  ...
  assert.match(dashboardHtml, /1 - Linha normal\\n2 - Subaba/, 'Financas add choice should distinguish ordinary rows from subtabs');
