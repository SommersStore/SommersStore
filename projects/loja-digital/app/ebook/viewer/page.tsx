...
// Importar estilos originais do cofre-v2 para fidelidade 1:1
...
// Importar Componentes Elite originais
...
export default function EbookFidelityViewer() {
  return (
    <div className="viewer-container" style={{ background: '#050508' }}>
      
      {/* Botão de Download Flutuante (Apenas Web Viewer) */}
      <div style={{
          position: 'fixed',
          top: '20px',
          right: '20px',
          ...
          <a href="/downloads/O_Cofre_das_Botanicas_Secretas.pdf" 
             style={{ 
                 color: '#C5A059', 
                 textDecoration: 'none', 
                 fontSize: '11px', 
      ...
      <div className="ebook-wrapper" style={{ 
        ...
        {/* REPLICAÇÃO FIEL DO LAYOUT A4 DO COFRE-V2 */}
        ...
        {/* PÁGINA FINAL (NÚMEROS ESTIMADOS BASEADOS NO V2) */}
