  ...
  return (
    <PageShell pageNum={pageNum} className="justify-center flex-col px-24">
      ...
      <div className="relative z-10 text-center mb-12">
        <p className="technical-label text-[12px] text-[#C5A059] tracking-[1.2em] font-bold uppercase mb-4">A Essência Ativa</p>
        <h2 className="title-gold italic text-6xl">Introdução Protocolar</h2>
        <div className="w-24 h-px bg-red-800 mx-auto mt-6" />
      </div>

      <div className="max-w-2xl mx-auto relative overflow-hidden bg-[#C5A059]/5 border border-[#C5A059]/10 p-12">
        ...
        <div className="relative z-10 space-y-6 text-[#F5F5DC]/70 font-serif italic text-lg leading-relaxed text-justify">
          <p className="text-2xl text-center mb-10 text-[#F5F5DC]/70">
