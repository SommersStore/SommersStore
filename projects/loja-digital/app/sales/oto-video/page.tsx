...
/**
 * OTO V2 — COM MINI VSL 9:16
 * Design: Nightshade Zen Dark
 */
export default function OTOVideoPage() {
    ...
    const otoCheckoutUrl = "https://pay.kiwify.com.br/kjKBBea"; // PLACEHOLDER
        ...
        <div className="min-h-screen bg-[#050508] text-[#F5F5DC] font-sans selection:bg-[#1a0a2e] selection:text-[#F5F5DC] overflow-x-hidden">
                    ...
                    <div className="animate-fade-up-delay-2">
                        ...
                        <div className="bg-[#0a0a14]/60 rounded-[3rem] md:rounded-[4rem] p-6 md:p-12 border border-[#C5A059]/15 relative overflow-hidden">
                            ...
                            <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
                                {/* Left Side: PROXY DO VSL 9:16 */}
                                <div className="order-2 md:order-1 relative w-full aspect-[9/16] rounded-2xl overflow-hidden border border-[#C5A059]/30 shadow-[0_0_40px_rgba(197,160,89,0.15)] bg-black flex items-center justify-center group max-w-sm mx-auto">
                                    {/* Video Placeholder (Mude src para seu Video/URL) */}
                                    <video 
                                        src="" 
                                        autoPlay loop muted playsInline
                                        className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500"
                                        poster="/sales/assets/oto-video-poster.jpg"
                                    ></video>
                                    ...
                                    <div className="absolute bottom-4 left-0 w-full text-center z-20">
                                       <span className="text-[10px] text-[#F5F5DC]/50 uppercase tracking-widest">[ VSL 9:16 PLACEHOLDER ]</span>
                                    </div>
                                </div>

                                {/* Right Side: O TEXTO ORIGINAL */}
                                <div className="order-1 md:order-2 space-y-8 text-center md:text-left">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4">
                                        {[
                                            "A Lágrima da Mirra",
                                            "Sal Vulcânico Negro",
                                            "Lavandas Azuis de Choque",
                                            "Efeito Entourage Fino"
                                        ].map((item, i) => (
            ...
            <section className="py-12 md:py-20 bg-gradient-to-b from-[#050508] via-[#080810] to-[#050508]">
                <div className="container mx-auto px-6 max-w-3xl text-center animate-fade-up-delay-3">
                    <h3 className="text-3xl md:text-4xl font-serif font-black text-white italic mb-6 leading-tight tracking-tighter">
                        Isso não é para o <span className="text-[#C5A059] underline decoration-[#1a0a2e] underline-offset-8">público geral.</span>
                    </h3>
                    <p className="text-lg text-[#F5F5DC]/70 font-serif italic leading-relaxed mb-8">
                        Se eu liberasse abertamente o <strong className="text-white not-italic">Cofre das Botânicas Secretas</strong>, a matéria-prima sumiria e o luxo seria corrompido. Mas você já cruzou a linha.
                    </p>
                </div>
            </section>
             ...
             <section className="py-12">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-10">
                        <span className="text-[#C5A059] font-black tracking-[0.5em] text-[9px] uppercase">Acesso Oculto Aprovado</span>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "O choque térmico do cardamomo escuro e sal vulcânico."
                            },
                            {
                                icon: "🌙",
                                title: "O Protocolo do Sono Real",
                                desc: "Inibição de córtex com altas doses de magnésio e lavanda azul."
                            },
                            {
                                icon: "🪬",
                                title: "O Purificador de Ambientes Cegos",
                                desc: "Defumação densa líquida para extirpar escassez financeira de pisos de loja."
                            }
                        ].map((module, i) => (
                            <div key={i} className="bg-[#0a0a14]/60 rounded-3xl p-6 md:p-8 border border-[#C5A059]/10 hover:border-[#C5A059]/30 transition-all duration-500 group">
                                <div className="flex gap-6 items-center">
                                    <span className="text-3xl md:text-4xl flex-shrink-0 group-hover:scale-110 transition-transform">{module.icon}</span>
                                    <div>
                                        <h4 className="text-xl md:text-2xl font-serif text-[#C5A059] font-black italic mb-2">{module.title}</h4>
                                        <p className="text-[#F5F5DC]/70 font-serif italic leading-relaxed text-sm md:text-base">{module.desc}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="text-center mt-6">
                        <span className="text-[#C5A059]/40 font-serif italic text-sm">+ 9 receitas e rituais da elite guardados no dossiê pdf de 30 páginas</span>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 max-w-3xl text-center">
                    ...
                    <div className="mb-8 space-y-3">
                        <p className="text-[#F5F5DC]/50 font-serif italic text-lg">
                            Valor médio de uma imersão nestes Spas Europeus:
                        </p>
                    ...
                    <div className="bg-[#0a0a14]/80 rounded-[4rem] p-10 md:p-16 border-2 border-[#C5A059]/30 relative overflow-hidden animate-pulse-gold">
                        ...
                        <p className="text-[#C5A059] font-black tracking-[0.3em] text-[10px] uppercase mb-6">
                            Oferta Vitalícia Única na Vida
                        </p>
                        ...
                        <a
                            href={otoCheckoutUrl}
                            className="block w-full max-w-lg mx-auto py-8 rounded-full bg-[#C5A059] text-center text-white font-black text-xl md:text-2xl border-4 border-[#FFD700] hover:bg-[#D4AF37] hover:scale-[1.03] transition-all duration-500 shadow-[0_0_50px_rgba(255,215,0,0.3)] hover:shadow-[0_0_80px_rgba(255,215,0,0.5)] uppercase tracking-[0.15em] mt-8 mb-6"
                        >
                            SIM, DESTRAVAR O COFRE
                        </a>
                    ...
                    <div className="mt-10">
                        ...
                        >
                            Não, serei parte do público comum. Dispensarei acesso às fórmulas ocultas da classe luxo.
                        </a>
                    </div>
                </div>
            </section>
