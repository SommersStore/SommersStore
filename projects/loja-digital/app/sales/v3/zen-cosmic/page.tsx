...
/**
 * VARIante Atômica: ZEN - COSMIC (Cosmic Purple Edition)
 * Mood: Deep Space, Cosmic Purple, Hot Pink & Solar Orange. Harmonizado com novas imagens.
 */
export default function ZenCosmic() {
    ...
    return (
        <div className="min-h-screen bg-[#08081A] text-[#F1F0FF] font-sans selection:bg-[#8B5CF6] selection:text-white overflow-x-hidden">
            ...
            <div className="bg-[#1A1040]/40 border-b border-[#2D1B69] py-4 text-center">
                 <span className="text-[#EC4899] font-black tracking-[0.5em] text-[10px] uppercase">Acesso Restrito: Alunas de Elite</span>
            </div>
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-12 md:py-24">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center max-w-6xl">
                    ...
                    <button onClick={() => document.getElementById('offer')?.scrollIntoView({ behavior: 'smooth' })} className="px-12 md:px-20 py-8 md:py-10 rounded-full bg-[#EC4899] text-white font-black text-xl md:text-2xl hover:bg-[#F97316] hover:scale-[1.05] transition-all duration-700 shadow-[0_20px_60px_rgba(139,92,246,0.4)] uppercase tracking-[0.2em]">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center text-left">
                        <div className="space-y-12">
                            <h2 className="text-4xl md:text-7xl font-serif text-white italic leading-tight">
                                Você sente sua energia sendo <br /> <span className="text-[#EC4899] underline decoration-purple-900 italic">drenada pelo caos diário?</span>
                            </h2>
                            <div className="space-y-8">
                                {pains.map((pain, i) => (
                                    <div key={i} className="flex gap-6 items-start border-l-4 border-purple-900/40 pl-8 py-4 bg-purple-950/20 rounded-r-3xl group hover:border-violet-500 transition-all">
                                        <span className="text-[#F97316] font-serif text-3xl mt-[-5px]">“</span>
                                        <span className="text-purple-50/80 text-lg md:text-xl font-serif italic leading-relaxed">{pain}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="relative aspect-[3/4] rounded-[3rem] md:rounded-[5rem] overflow-hidden border border-[#2D1B69] shadow-2xl grayscale saturate-50 hover:grayscale-0 transition-all duration-1000">
            ...
            <section className="py-12 md:py-28 bg-[#0E0E2A]">
                <div className="container mx-auto px-6 text-center max-w-5xl">
                    <span className="text-[#EC4899] font-black tracking-[0.5em] text-[10px] uppercase mb-8 block">A Base da Alquimia</span>
                    ...
                    <p className="text-xl md:text-2xl text-purple-50/80 leading-relaxed mb-20 md:mb-32 font-serif italic max-w-4xl mx-auto">
                    ...
                    <div className="bg-[#1A1040]/30 rounded-[3rem] md:rounded-[6rem] p-10 md:p-24 border border-purple-900/40 text-left relative overflow-hidden group shadow-inner">
                        <div className="relative z-10 max-w-2xl">
                            <h4 className="text-3xl md:text-4xl font-serif text-[#EC4899] mb-8 italic font-black">O Poder da Terra nas suas Mãos</h4>
                            <p className="text-lg md:text-xl text-purple-50/80 leading-relaxed font-serif italic">
                        ...
                        <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 group-hover:opacity-30 transition-all flex">
                             ...
                             <div className="relative w-1/2 h-full border-l border-purple-900/20"> <Image src="/sales/assets/ChatGPT Image 9 de fev. de 2026, 00_11_24.png" alt="Alchemy 2" fill className="object-cover" /> </div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-[#0A0A20] border-y border-purple-900/20">
                <div className="container mx-auto px-6 max-w-5xl text-center">
                    <div className="flex justify-center mb-10 text-[#EC4899]/30"><span className="text-4xl">🌿</span></div>
                    ...
                    <p className="text-lg md:text-xl text-purple-50/80 font-serif italic mb-16 italic">Imagine sua rotina apenas 30 dias após este método:</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left">
                        {[
                            ...
                            <div key={i} className="flex flex-col gap-6 bg-[#1A1040]/20 p-8 rounded-[2.5rem] border border-[#2D1B69] shadow-sm hover:shadow-md transition-all overflow-hidden group">
                                ...
                                <div className="flex gap-4 items-center">
                                    <div className="w-8 h-8 rounded-full bg-purple-900 flex items-center justify-center text-[#EC4899] text-xs font-black flex-shrink-0">✓</div>
                                    <span className="text-purple-50/80 font-serif italic text-lg leading-tight">{item.t}</span>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-12 md:py-28 bg-[#0E0E2A]">
                <div className="container mx-auto px-6 max-w-6xl">
                    <span className="text-center block text-[#EC4899] font-black tracking-[0.5em] text-[10px] uppercase mb-8">Vozes da Transformação</span>
                    <h2 className="text-center text-4xl md:text-[80px] font-serif font-black text-white italic mb-16 md:mb-24 tracking-tighter leading-tight">Histórias de quem escolheu <br/> <span className="underline decoration-purple-900 underline-offset-8">viver a Alquimia.</span></h2>
                    
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                        {testimonials.map((t, i) => (
                            <div key={i} className="bg-[#1A1040]/30 p-10 md:p-16 rounded-[3.5rem] border border-[#2D1B69] relative flex flex-col justify-between hover:bg-purple-950/40 transition-colors group shadow-2xl">
                                <div className="text-6xl text-purple-900/20 font-serif absolute top-10 left-10">“</div>
                                <p className="text-lg md:text-2xl text-purple-50/80 italic font-serif leading-relaxed mb-12 relative z-10">
                                    {t.text}
                                </p>
                                <div className="h-px w-full bg-purple-900/10 mb-8" />
                                <div className="flex items-center gap-6">
                                    <div className="w-20 h-20 rounded-full border border-purple-800/50 overflow-hidden relative shadow-lg">
            ...
            <section className="py-12 md:py-28 bg-[#0A0A20] border-y border-purple-900/20">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8">
                        {phases.map((p, i) => (
                            <div key={i} className="group bg-[#1A1040]/30 rounded-[3rem] overflow-hidden border border-purple-900/40 shadow-2xl hover:shadow-purple-900/20 transition-all duration-700 flex flex-col h-full">
                                <div className="relative h-64 w-full">
                                    ...
                                    <div className="absolute top-6 left-6 w-16 h-16 rounded-full bg-[#2D1B69] border border-purple-100/10 text-[#EC4899] flex items-center justify-center text-2xl font-black shadow-xl">0{i+1}</div>
                                </div>
            ...
            <section className="py-12 md:py-28 bg-[#0E0E2A]">
                <div className="container mx-auto px-6 max-w-6xl text-center">
                    <span className="text-[#EC4899] font-black tracking-[0.5em] text-[10px] uppercase mb-8 block">Presentes de Elite</span>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        {bonuses.map((b, i) => (
                            <div key={i} className="bg-[#1A1040]/20 border border-[#2D1B69] rounded-[4rem] overflow-hidden text-left relative group shadow-inner hover:scale-[1.02] transition-all">
                                <div className="relative h-48 w-full bg-purple-950">
                                    ...
                                    <div className="absolute top-6 left-6 px-4 py-2 rounded-full bg-[#2D1B69] border border-purple-100/10 text-[#EC4899] text-[10px] font-black uppercase tracking-widest shadow-lg">PRESENTE 0{i+1}</div>
                                </div>
                                <div className="p-12">
                                    <h4 className="text-2xl font-serif text-white mb-6 italic leading-tight font-black">{b.title}</h4>
                                    <p className="text-purple-50/80 font-serif italic mb-8 leading-relaxed">{b.desc}</p>
                                    <div className="pt-6 border-t border-purple-900/20 flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-[#F97316]/40">
            ...
            <section id="offer" className="py-12 md:py-28 bg-[#0A0A20]">
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    <div className="mb-12 space-y-4">
                         <span className="inline-block py-2 px-8 rounded-full bg-[#EC4899] text-white font-black tracking-[0.3em] text-[10px] uppercase shadow-xl">Acesso Vitalício Liberado</span>
                         <h2 className="text-4xl md:text-[80px] font-serif font-black text-white italic tracking-tighter leading-none">O SEU RITUAL <br/> <span className="text-[#EC4899] underline decoration-purple-100 underline-offset-[10px] md:underline-offset-[20px]">COMEÇA AGORA.</span></h2>
                    </div>
                    
                    <div className="relative">
                        <div className="absolute inset-0 bg-[#2D1B69] rounded-[5rem] -rotate-1 scale-105 -z-10 opacity-20" />
                        <div className="bg-[#1A1040]/40 rounded-[4rem] md:rounded-[6rem] p-10 md:p-24 border-8 border-purple-950 shadow-4xl relative overflow-hidden">
                            ...
                            <div className="grid md:grid-cols-2 gap-16 items-center">
                                <div className="text-left space-y-8">
                                    ...
                                    <div className="py-4 px-8 rounded-full bg-[#2D1B69] text-[#EC4899] font-bold tracking-wider text-xs uppercase inline-block text-left border border-violet-500/20">
                                ...
                                <div className="space-y-12 text-center">
                                    ...
                                    <button className="w-full py-10 rounded-full bg-[#EC4899] text-white font-black text-2xl md:text-3xl hover:bg-[#F97316] hover:scale-[1.05] transition-all shadow-3xl uppercase tracking-[0.2em] leading-none">
            ...
            <section className="py-12 md:py-28 bg-[#0E0E2A]">
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center text-left">
                        ...
                        <div className="space-y-12">
                             <span className="text-[#EC4899] font-black tracking-[0.5em] text-[10px] uppercase">A Criadora</span>
                             ...
                             <div className="text-[#EC4899] font-serif italic text-3xl font-black">— Elisa Clark Brasil</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-[#0A0A20] border-y border-purple-900/20 text-center">
                <div className="container mx-auto px-6 max-w-3xl">
                    <div className="inline-block px-12 py-12 rounded-full border border-[#2D1B69] bg-[#1A1040]/30 mb-12 relative overflow-hidden group shadow-inner">
                ...
                <div className="container mx-auto px-6 max-w-4xl text-left">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="bg-[#1A1040]/30 border border-purple-900/20 rounded-[2.5rem] overflow-hidden shadow-sm">
                                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full p-8 md:p-10 flex justify-between items-center text-left hover:bg-purple-950/40 transition-colors">
                                ...
                                {openFaq === i && (
                                    <div className="p-10 pt-0 text-purple-50/80 font-serif italic leading-relaxed border-t border-purple-900/20 mt-[-1px]">
                                        {faq.a}
                                    </div>
                                )}
                            </div>
            ...
            <footer className="py-20 md:py-32 bg-[#0A0A20] text-center border-t border-purple-900/20">
                 <div className="container mx-auto px-6">
                    <div className="flex flex-col items-center gap-12">
                        <div className="text-purple-50/80 font-black tracking-[1.2rem] text-[10px] uppercase font-sans">Sommers Store • Digital Arts</div>
                        <div className="h-px w-20 bg-purple-900/40" />
                        <div className="text-purple-100/5 text-[9px] font-black uppercase tracking-[1em] font-sans">© 2026 Engenharia Atômica SommersStore</div>
                        <div className="mt-8 opacity-20">
                             <div className="flex gap-8 text-[8px] uppercase tracking-widest text-[#EC4899] font-black">
                                 <span>Alquimia</span>
                                 <span>Mineral</span>
                                 <span>Elite</span>
                             </div>
