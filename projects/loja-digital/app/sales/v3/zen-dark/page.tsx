...
/**
 * VARIante Atômica: ZEN - DARK (V3 Premium - Full Master Synchronization)
 * Mood: Deep Emerald & Night, Candlelight, Mistério.
 * Reconstruída para espelhar as 13 seções da Master Live.
 */
export default function ZenDarkMaster() {
    ...
    return (
        <div className="min-h-screen bg-[#051510] text-[#e8f5e9] font-sans selection:bg-emerald-900 selection:text-emerald-100 overflow-x-hidden">

            {/* 1. RESTRICT ACCESS LABEL */}
            <div className="bg-[#0a2a22]/40 border-b border-emerald-900/30 py-4 text-center">
                 <span className="text-emerald-400 font-black tracking-[0.5em] text-[10px] uppercase">Acesso Restrito: Alunas de Elite</span>
            </div>
                ...
                <div className="relative z-10 container mx-auto px-6 text-center max-w-6xl">
                    <h1 className="text-5xl md:text-[110px] font-serif font-black text-white mb-8 md:mb-12 leading-[0.9] tracking-tighter">
                        {product.promise.split(' ').map((word, i) => (
                            word === "Alquimia" ? <span key={i} className="text-emerald-400 italic block md:inline underline decoration-emerald-800 underline-offset-[15px]"> {word} </span> : " " + word
                        ))}
                    </h1>

                    <p className="text-xl md:text-2xl text-emerald-100/60 mb-12 md:mb-20 max-w-4xl mx-auto leading-relaxed font-serif italic">
                    ...
                    <button onClick={() => document.getElementById('offer')?.scrollIntoView({ behavior: 'smooth' })} className="px-12 md:px-20 py-8 md:py-10 rounded-full bg-emerald-600 text-white font-black text-xl md:text-2xl hover:bg-emerald-500 hover:scale-[1.05] transition-all duration-700 shadow-[0_20px_60px_rgba(5,150,105,0.4)] uppercase tracking-[0.2em]">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center text-left">
                        <div className="space-y-12">
                            <h2 className="text-4xl md:text-7xl font-serif text-white italic leading-tight">
                                Você sente sua energia sendo <br /> <span className="text-emerald-400 underline decoration-emerald-900 italic">drenada pelo caos diário?</span>
                            </h2>
                            <div className="space-y-8">
                                {pains.map((pain, i) => (
                                    <div key={i} className="flex gap-6 items-start border-l-4 border-emerald-900/40 pl-8 py-4 bg-emerald-950/20 rounded-r-3xl group hover:border-emerald-500 transition-all">
                                        <span className="text-emerald-500 font-serif text-3xl mt-[-5px]">“</span>
                                        <span className="text-emerald-100/80 text-lg md:text-xl font-serif italic leading-relaxed">{pain}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="relative aspect-[3/4] rounded-[3rem] md:rounded-[5rem] overflow-hidden border border-emerald-900/30 shadow-2xl grayscale saturate-50 hover:grayscale-0 transition-all duration-1000">
            ...
            <section className="py-12 md:py-28 bg-[#051510]">
                <div className="container mx-auto px-6 text-center max-w-5xl">
                    <span className="text-emerald-400 font-black tracking-[0.5em] text-[10px] uppercase mb-8 block">A Base da Alquimia</span>
                    ...
                    <p className="text-xl md:text-2xl text-emerald-100/50 leading-relaxed mb-20 md:mb-32 font-serif italic max-w-4xl mx-auto">
                    ...
                    <div className="bg-[#0a2a22]/30 rounded-[3rem] md:rounded-[6rem] p-10 md:p-24 border border-emerald-900/40 text-left relative overflow-hidden group shadow-inner">
                        <div className="relative z-10 max-w-2xl">
                            <h4 className="text-3xl md:text-4xl font-serif text-emerald-400 mb-8 italic font-black">O Poder da Terra nas suas Mãos</h4>
                            <p className="text-lg md:text-xl text-emerald-100/70 leading-relaxed font-serif italic">
            ...
            <section className="py-12 md:py-28 bg-[#030d0a] border-y border-emerald-900/20">
                <div className="container mx-auto px-6 max-w-5xl text-center">
                    <div className="flex justify-center mb-10 text-emerald-400/30"><span className="text-4xl">🌿</span></div>
                    ...
                    <p className="text-lg md:text-xl text-emerald-100/40 font-serif italic mb-16 italic">Imagine sua rotina apenas 30 dias após este método:</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left">
                        {[
                            ...
                            <div key={i} className="flex gap-6 items-center bg-[#0a2a22]/20 p-8 rounded-[2.5rem] border border-emerald-900/30">
                                <div className="w-10 h-10 rounded-full bg-emerald-900 flex items-center justify-center text-emerald-400 text-xs font-black">✓</div>
                                <span className="text-emerald-100/80 font-serif italic text-lg">{item}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-12 md:py-28 bg-[#051510]">
                <div className="container mx-auto px-6 max-w-6xl">
                    <span className="text-center block text-emerald-400 font-black tracking-[0.5em] text-[10px] uppercase mb-8">Vozes da Transformação</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                        {testimonials.map((t, i) => (
                            <div key={i} className="bg-[#0a2a22]/30 p-10 md:p-16 rounded-[3.5rem] border border-emerald-900/30 relative flex flex-col justify-between hover:bg-emerald-950/40 transition-colors group shadow-2xl">
                                <div className="text-6xl text-emerald-900/20 font-serif absolute top-10 left-10">“</div>
                                <p className="text-lg md:text-2xl text-emerald-100/80 italic font-serif leading-relaxed mb-12 relative z-10">
                                    {t.text}
                                </p>
                                <div className="flex items-center gap-6">
                                    <div className="w-16 h-16 rounded-3xl bg-emerald-950 border border-emerald-900/50 overflow-hidden relative">
            ...
            <section className="py-12 md:py-28 bg-[#030d0a] border-y border-emerald-900/20">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="space-y-12">
                        {phases.map((p, i) => (
                            <div key={i} className="flex flex-col md:flex-row gap-8 md:gap-16 items-start border-b border-emerald-900/20 pb-12 group text-left">
                                <span className="text-7xl md:text-9xl font-serif font-black text-emerald-950 group-hover:text-emerald-900/30 transition-all duration-700">0{i+1}</span>
                                <div className="pt-4">
                                    <h4 className="text-2xl md:text-3xl font-serif text-emerald-400 mb-6 italic font-black underline decoration-emerald-800 underline-offset-8 decoration-2">{p.title}</h4>
                                    <p className="text-emerald-100/50 text-xl font-serif italic leading-relaxed">{p.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-12 md:py-28 bg-[#051510]">
                <div className="container mx-auto px-6 max-w-6xl text-center">
                    <span className="text-emerald-400 font-black tracking-[0.5em] text-[10px] uppercase mb-8 block">Presentes de Elite</span>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        {bonuses.map((b, i) => (
                            <div key={i} className="bg-[#0a2a22]/20 border border-emerald-900/30 rounded-[4rem] p-12 text-left relative overflow-hidden group shadow-inner">
                                ...
                                <span className="text-emerald-400 font-black text-xs uppercase tracking-widest block mb-4">Bônus {i+1}</span>
                                <h4 className="text-2xl font-serif text-white mb-6 italic leading-tight font-black">{b.title}</h4>
                                <p className="text-emerald-100/40 font-serif italic mb-8 leading-relaxed">{b.desc}</p>
                                <div className="pt-6 border-t border-emerald-900/20 flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-emerald-500/40">
            ...
            <section id="offer" className="py-12 md:py-28 bg-[#030d0a]">
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    <div className="mb-20 space-y-6">
                         ...
                         <h2 className="text-5xl md:text-[100px] font-serif font-black text-white italic tracking-tighter leading-none mb-12">Faça as Pazes <br/> <span className="underline decoration-emerald-800 underline-offset-[10px] md:underline-offset-[25px]">com o Tempo.</span></h2>
                    </div>
                    
                    <div className="bg-[#0a2a22]/40 rounded-[4rem] md:rounded-[6rem] p-10 md:p-32 border border-emerald-800/20 shadow-4xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-10 opacity-10 text-9xl text-emerald-400">💎</div>
                        
                        <div className="space-y-12 mb-20 md:mb-24 text-emerald-100">
                            <span className="text-emerald-100/30 line-through text-4xl italic font-serif opacity-60">De R$ 197,00 por apenas</span>
                            <div className="flex flex-col items-center gap-2">
                                <div className="flex items-baseline gap-4 group cursor-default">
                                    <span className="text-4xl md:text-5xl font-black text-emerald-400">R$</span>
                                    ...
                                    <div className="text-left font-black">
                                        <div className="text-[50px] md:text-[100px] text-emerald-400 leading-none">,{product.price.split(',')[1]}</div>
                                    </div>
                                </div>
                                <p className="py-4 md:py-6 px-8 md:px-12 rounded-full border border-emerald-900/50 bg-emerald-950/80 text-emerald-400 font-black tracking-widest text-[10px] uppercase shadow-xl mt-[-10px] md:mt-[-20px]">Pagamento Único • Vitalício</p>
                            </div>
                        </div>
            ...
            <section className="py-12 md:py-28 bg-[#051510]">
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center text-left">
                        <div className="relative aspect-[3/4] rounded-[4rem] md:rounded-[6rem] overflow-hidden border border-emerald-900/30 shadow-2xl grayscale saturate-50 hover:grayscale-0 transition-all duration-1000">
                             <Image src="/sales/assets/zen-light-bio.png" alt="Elisa Clark" fill className="object-cover" />
                        </div>
                        <div className="space-y-12">
                             <span className="text-emerald-400 font-black tracking-[0.5em] text-[10px] uppercase">A Criadora</span>
                             <h2 className="text-5xl md:text-7xl font-serif italic text-white leading-tight">Eu te guiarei nesse portal de abundância.</h2>
                             <p className="text-lg md:text-xl text-emerald-100/50 font-serif italic leading-relaxed">
                             ...
                             <div className="text-emerald-400 font-serif italic text-3xl font-black">— Elisa Clark Brasil</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-[#030d0a] border-y border-emerald-900/20 text-center">
                <div className="container mx-auto px-6 max-w-3xl">
                    <div className="inline-block px-12 py-12 rounded-full border border-emerald-900/30 bg-[#0a2a22]/30 mb-12 relative overflow-hidden group shadow-inner">
                         <div className="text-6xl mb-4 group-hover:scale-110 transition-transform">🛡️</div>
                    </div>
                    <h2 className="text-4xl font-serif text-white mb-8 italic font-black">Risco Zero. Transmutação Garantida.</h2>
                    <p className="text-lg md:text-xl text-emerald-100/40 font-serif italic mb-12">
                        ...
                        {[
                            ...
                            <div key={i} className="bg-[#0a2a22]/30 border border-emerald-900/20 rounded-[2.5rem] overflow-hidden shadow-sm">
                                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full p-8 md:p-10 flex justify-between items-center text-left hover:bg-emerald-950/40 transition-colors">
                                    ...
                                    <span className={`text-emerald-400 transform transition-transform text-2xl ${openFaq === i ? 'rotate-45' : ''}`}>+</span>
                                </button>
                                {openFaq === i && (
                                    <div className="p-10 pt-0 text-emerald-100/40 font-serif italic leading-relaxed border-t border-emerald-900/20 mt-[-1px]">
                                        {faq.a}
                                    </div>
                                )}
                            </div>
            ...
            <footer className="py-20 md:py-32 bg-[#030d0a] text-center border-t border-emerald-900/20">
                 <div className="container mx-auto px-6">
                    <div className="flex flex-col items-center gap-12">
                        <div className="text-emerald-100/10 font-black tracking-[1.2rem] text-[10px] uppercase font-sans">Sommers Store • Digital Arts</div>
                        ...
                        <div className="mt-8 opacity-20">
                             <div className="flex gap-8 text-[8px] uppercase tracking-widest text-emerald-400 font-black">
                                 <span>Alquimia</span>
                                 <span>Mineral</span>
                                 <span>Elite</span>
                             </div>
