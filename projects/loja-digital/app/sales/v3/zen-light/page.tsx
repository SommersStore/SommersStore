...
/**
 * VARIante Atômica: ZEN - LIGHT (V3 Premium - Full Master Synchronization)
 * Mood: Cream & Emerald, Wabi-sabi, Luz de Fim de Tarde.
 * Reconstruída para espelhar as 13 seções da Master Live.
 */
export default function ZenLightMaster() {
    ...
    return (
        <div className="min-h-screen bg-[#fcf9f6] text-[#3e342b] font-sans selection:bg-emerald-100 selection:text-emerald-900 overflow-x-hidden">

            {/* 1. RESTRICT ACCESS LABEL */}
            <div className="bg-white border-b border-emerald-50 py-4 text-center">
                 <span className="text-emerald-800 font-black tracking-[0.5em] text-[10px] uppercase">Acesso Restrito: Alunas de Elite</span>
            </div>
                ...
                <div className="relative z-10 container mx-auto px-6 text-center max-w-6xl">
                    <h1 className="text-5xl md:text-[110px] font-serif font-black text-[#2d241e] mb-8 md:mb-12 leading-[0.9] tracking-tighter">
                        {product.promise.split(' ').map((word, i) => (
                            word === "Alquimia" ? <span key={i} className="text-emerald-800 italic block md:inline underline decoration-emerald-200 underline-offset-[15px]"> {word} </span> : " " + word
                        ))}
                    </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
                        <div className="space-y-12">
                            <h2 className="text-4xl md:text-7xl font-serif text-[#2d241e] italic leading-tight">
                                Você sente sua energia sendo <br /> <span className="text-emerald-800 underline decoration-emerald-100 italic">drenada pelo caos diário?</span>
                            </h2>
                            <div className="space-y-8">
                                {pains.map((pain, i) => (
                                    <div key={i} className="flex gap-6 items-start border-l-4 border-emerald-50 pl-8 py-4 bg-[#fcf9f6]/40 rounded-r-3xl group hover:border-emerald-200 transition-all">
            ...
            <section className="py-12 md:py-28 bg-[#fcf9f6]">
                <div className="container mx-auto px-6 text-center max-w-5xl">
                    ...
                    <div className="bg-white rounded-[3rem] md:rounded-[6rem] p-10 md:p-24 border border-emerald-50 text-left relative overflow-hidden group shadow-2xl">
                        <div className="relative z-10 max-w-2xl">
                            <h4 className="text-3xl md:text-4xl font-serif text-emerald-800 mb-8 italic font-black">O Poder da Terra nas suas Mãos</h4>
                        ...
                        <div className="absolute top-0 right-0 w-1/2 h-full opacity-20 group-hover:opacity-40 transition-all">
                             <Image src="/sales/assets/zen-light-alchemy.png" alt="Alchemy Texture" fill className="object-cover" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-white border-y border-emerald-50">
                <div className="container mx-auto px-6 max-w-5xl text-center">
                    <div className="flex justify-center mb-10 text-emerald-800/30"><span className="text-4xl text-emerald-600">🌿</span></div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left">
                        {[
                            ...
                            <div key={i} className="flex gap-6 items-center bg-[#fcf9f6]/60 p-8 rounded-[2.5rem] border border-emerald-50 shadow-sm">
                                <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700 text-xs font-black">✓</div>
                                <span className="text-[#3e342b] font-serif italic text-lg">{item}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                        {testimonials.map((t, i) => (
                            <div key={i} className="bg-white p-10 md:p-16 rounded-[3.5rem] border border-emerald-50 relative flex flex-col justify-between hover:bg-emerald-50/20 transition-colors group shadow-xl">
                                <div className="text-6xl text-emerald-100 font-serif absolute top-10 left-10">“</div>
                                <p className="text-lg md:text-2xl text-[#3e342b] italic font-serif leading-relaxed mb-12 relative z-10">
                                    {t.text}
                                </p>
                                <div className="flex items-center gap-6">
                                    <div className="w-16 h-16 rounded-3xl bg-emerald-50 border border-emerald-100 overflow-hidden relative">
                                        <div className="absolute inset-0 flex items-center justify-center text-emerald-800 font-black text-xs">{t.name[0]}</div>
                                    </div>
                                    <div>
                                        <div className="text-[#2d241e] font-black text-sm uppercase tracking-widest">{t.name}</div>
                                        <div className="text-emerald-600/60 font-black text-[9px] uppercase tracking-[0.3em]">{t.loc}</div>
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="py-12 md:py-28 bg-white border-y border-[#f0ede9]">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="space-y-12">
                        {phases.map((p, i) => (
                            <div key={i} className="flex flex-col md:flex-row gap-8 md:gap-16 items-start border-b border-emerald-50 pb-12 group">
                                <span className="text-7xl md:text-9xl font-serif font-black text-emerald-50 group-hover:text-emerald-100 transition-all duration-700">0{i+1}</span>
                                <div className="pt-4 text-left">
                                    <h4 className="text-2xl md:text-3xl font-serif text-emerald-900 mb-6 italic font-black underline decoration-emerald-200 underline-offset-8 decoration-2">{p.title}</h4>
            ...
            <section className="py-12 md:py-28 bg-[#fcf9f6]">
                <div className="container mx-auto px-6 max-w-6xl text-center">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        {bonuses.map((b, i) => (
                            <div key={i} className="bg-white border border-emerald-50 rounded-[4rem] p-12 text-left relative overflow-hidden group shadow-xl">
                                ...
                                <span className="text-emerald-700 font-black text-xs uppercase tracking-widest block mb-4">Bônus {i+1}</span>
                                ...
                                <div className="pt-6 border-t border-emerald-50 flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-emerald-800/40">
            ...
            <section id="offer" className="py-12 md:py-28 bg-white">
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    <div className="mb-20 space-y-6">
                         <span className="text-emerald-600 font-black tracking-[0.6em] text-[10px] uppercase">O Convite Final</span>
                         <h2 className="text-5xl md:text-[100px] font-serif font-black text-[#2d241e] italic tracking-tighter leading-none mb-12">Faça as Pazes <br/> <span className="underline decoration-emerald-200 underline-offset-[10px] md:underline-offset-[25px]">com o Tempo.</span></h2>
                    </div>
                    
                    <div className="bg-[#fcf9f6] rounded-[4rem] md:rounded-[6rem] p-10 md:p-32 border border-emerald-100 shadow-4xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-10 opacity-10 text-9xl text-emerald-200">💎</div>
                        
                        <div className="space-y-12 mb-20 md:mb-24">
                            <span className="text-[#a89686] line-through text-4xl italic font-serif opacity-60">De R$ 197,00 por apenas</span>
                            <div className="flex flex-col items-center gap-2">
                                <div className="flex items-baseline gap-4 group cursor-default">
                                    <span className="text-4xl md:text-5xl font-black text-emerald-700">R$</span>
                                    <span className="text-[100px] md:text-[260px] font-serif font-black text-[#2d241e] tracking-tighter leading-none transition-all group-hover:text-emerald-800">{product.price.split(',')[0]}</span>
                                    <div className="text-left font-black">
                                        <div className="text-[50px] md:text-[100px] text-emerald-700 leading-none">,{product.price.split(',')[1]}</div>
                                    </div>
                                </div>
                                <p className="py-4 md:py-6 px-8 md:px-12 rounded-full border border-emerald-500/30 bg-emerald-900 text-emerald-100 font-black tracking-widest text-[10px] uppercase shadow-xl mt-[-10px] md:mt-[-20px]">Pagamento Único • Vitalício</p>
                            </div>
                        </div>

                        <button className="w-full py-10 md:py-12 rounded-full bg-emerald-600 text-white font-black text-2xl md:text-4xl hover:bg-emerald-700 hover:scale-[1.05] transition-all shadow-3xl uppercase tracking-[0.3em] leading-none mb-12">
                            Quero Começar Agora
                        </button>
                        
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 opacity-40">
                             <div className="flex items-center gap-4 text-[#2d241e]">
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center text-left">
                        ...
                        <div className="space-y-12">
                             ...
                             <div className="text-emerald-800 font-serif italic text-3xl font-black">— Elisa Clark Brasil</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-white border-y border-emerald-50 text-center">
                ...
                <div className="container mx-auto px-6 max-w-4xl text-left">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="bg-white border border-emerald-50 rounded-[2.5rem] overflow-hidden shadow-sm">
                                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full p-8 md:p-10 flex justify-between items-center text-left hover:bg-emerald-50/20 transition-colors">
                                    ...
                                    <span className={`text-emerald-800 transform transition-transform text-2xl ${openFaq === i ? 'rotate-45' : ''}`}>+</span>
                                </button>
                                {openFaq === i && (
                                    <div className="p-10 pt-0 text-[#6b5847] font-serif italic leading-relaxed border-t border-emerald-50 mt-[-1px]">
                                        {faq.a}
                                    </div>
                                )}
                            </div>
            ...
            <footer className="py-20 md:py-32 bg-white text-center border-t border-emerald-50">
                 <div className="container mx-auto px-6">
                    <div className="flex flex-col items-center gap-12">
                        ...
                        <div className="mt-8 opacity-40">
                             <div className="flex gap-8 text-[8px] uppercase tracking-widest text-emerald-800 font-black">
                                 <span>Alquimia</span>
                                 <span>Mineral</span>
                                 <span>Elite</span>
                             </div>
