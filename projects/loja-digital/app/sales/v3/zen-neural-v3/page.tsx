...
/**
 * VARIante Atômica: ZEN - NEURAL V3 (Teal Tech Edition)
 * Deep Navy, Electric Teal & Signal Orange. Copy Reformulada.
 */
export default function ZenNeuralV3() {
        ...
        <div className="min-h-screen bg-[#060D14] text-[#E0F7FA] font-sans selection:bg-[#0E3048] selection:text-[#E0F7FA] overflow-x-hidden">
            ...
            <div className="bg-[#0D2030]/40 border-b border-[#0E3048] py-4 text-center">
                 <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-0">
                    <span className="text-[#14B8A6] font-black tracking-[0.3em] md:tracking-[0.5em] text-[10px] uppercase underline decoration-teal-400/30 underline-offset-4">Método Essência Ativa BR</span>
                    <span className="text-cyan-50/20 mx-4 hidden md:inline">—</span>
                    <span className="text-cyan-50/40 text-[9px] uppercase tracking-widest font-black">Sais de Banho Terapêuticos</span>
                 </div>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center text-left">
                        <div className="space-y-6 md:space-y-12">
                             <div className="flex md:hidden justify-center mb-8">
                                <span className="py-2 px-6 rounded-full bg-[#14B8A6]/10 border border-[#14B8A6]/20 text-[#14B8A6] text-[10px] uppercase font-black tracking-widest flex items-center gap-2 whitespace-nowrap">
                                    A Jornada Começa Aqui
                                    <span className="w-4 h-[1px] bg-[#14B8A6]/40"></span>
                                </span>
                             </div>

                             <h2 className="text-4xl md:text-[64px] font-serif font-black text-white italic mb-12 md:mb-16 leading-[1.1] tracking-tighter">
                                Você sente sua energia sendo <br className="hidden md:block"/> <span className="text-[#14B8A6] underline decoration-cyan-900 underline-offset-8">drenada pelo caos diário?</span>
                            </h2>
                            <div className="space-y-5 md:space-y-8">
                                {pains.map((pain, i) => (
                                    <div key={i} className="flex gap-6 items-start border-l-4 border-cyan-900/40 pl-8 py-4 bg-cyan-950/20 rounded-r-3xl group hover:border-teal-400 transition-all">
                                        <span className="text-[#14B8A6] font-serif text-3xl mt-[-5px]">“</span>
                                        <p className="text-cyan-50/80 font-serif italic text-lg leading-relaxed">{pain}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="relative aspect-[3/4] rounded-[3rem] md:rounded-[5rem] overflow-hidden border border-cyan-900/20 shadow-2xl grayscale saturate-50 hover:grayscale-0 transition-all duration-1000">
            ...
            <section id="method" className="py-20 md:py-32 bg-[#060D14] relative overflow-hidden text-center md:text-left">
                 <div className="container mx-auto px-6 max-w-6xl relative z-10">
                    <div className="flex md:hidden justify-center mb-12">
                        <span className="py-2 px-6 rounded-full bg-[#14B8A6]/10 border border-[#14B8A6]/20 text-[#14B8A6] text-[10px] uppercase font-black tracking-widest flex items-center gap-2 whitespace-nowrap">
                            Explore a Jornada
                            <span className="text-[#14B8A6] animate-swipe">→</span>
                        </span>
                    </div>
                    ...
                    <div onScroll={handleScroll('phases')} className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-6 md:grid md:grid-cols-3 md:gap-12 pb-12 md:pb-0">
                         {phases.map((phase, i) => (
                             <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group relative p-10 md:p-12 rounded-[2.5rem] md:rounded-[4rem] bg-cyan-950/20 border border-cyan-900/20 hover:border-cyan-800/40 transition-all duration-700">
                                 <div className="w-16 h-16 rounded-2xl bg-[#14B8A6] text-white flex items-center justify-center text-2xl font-black mb-8 group-hover:scale-110 transition-transform shadow-[0_10px_30px_rgba(20,184,166,0.3)]">0{i+1}</div>
                                 <h3 className="text-2xl md:text-3xl font-serif font-black text-white mb-6 uppercase tracking-tighter italic">{phase.title}</h3>
                                 <p className="text-cyan-50/70 text-lg leading-relaxed">{phase.desc}</p>
                             </div>
                         ))}
                    </div>

                    <div className="mt-8 md:hidden">
                        <div className="w-full h-[1px] bg-cyan-900/20 rounded-full overflow-hidden">
                            <div 
                    ...
                    <div className="mt-20 md:mt-32">
                        <div className="bg-[#0D2030]/30 rounded-[3rem] md:rounded-[6rem] px-6 py-10 md:px-24 md:py-16 border border-cyan-900/40 text-center md:text-left relative overflow-hidden group shadow-inner">
                            <div className="relative z-10 max-w-2xl">
                                <h4 className="text-4xl md:text-[40px] font-serif text-[#14B8A6] mb-8 italic font-black text-center md:text-left">
                                 ...
                                 <p className="text-lg md:text-xl text-cyan-50/80 leading-relaxed font-serif italic text-center md:text-left">
                            ...
                            <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 group-hover:opacity-50 transition-all hidden md:flex">
                                 <div className="relative w-1/2 h-full bg-cyan-950/20"> </div>
                                 <div className="relative w-1/2 h-full border-l border-cyan-900/20"> <Image src="/sales/assets/zen-method-1.png" alt="Alchemy 2" fill className="object-cover" /> </div>
                            </div>
                        </div>
                    </div>
                 </div>
            ...
            <section className="py-12 md:py-28 bg-[#040A10] border-y border-cyan-900/20">
                <div className="container mx-auto px-6 max-w-5xl text-center">
                    ...
                    <p className="text-lg md:text-xl text-[#14B8A6] font-serif italic mb-16">Imagine sua rotina apenas 30 dias após aplicar o <strong className="text-white not-italic">Método Essência Ativa BR</strong>:</p>
                    ...
                    <div onScroll={handleScroll('reality')} className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-6 md:grid md:grid-cols-2 md:gap-12 pb-12 md:pb-0">
                        {[
                            ...
                            <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group bg-[#060D14]/40 p-8 rounded-[2.5rem] border border-cyan-900/10 hover:border-cyan-800/30 transition-all duration-700 shadow-xl overflow-hidden">
                                ...
                                <div className="flex gap-4 items-center">
                                    <div className="w-8 h-8 rounded-full bg-cyan-900/40 flex items-center justify-center text-[#14B8A6] text-xs font-black flex-shrink-0">✓</div>
                                    <span className="text-cyan-50/80 font-serif italic text-lg leading-tight text-left">{item.t}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="md:hidden mt-8">
                        <div className="w-full h-[1px] bg-cyan-900/20 rounded-full overflow-hidden">
                            <div className="h-full bg-[#14B8A6] transition-all duration-300" style={{ width: `${scrolled.reality || 0}%` }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-32 bg-[#0D2030]/30">
                <div className="container mx-auto px-6 max-w-6xl text-center md:text-left">
                    ...
                    <div onScroll={handleScroll('voices')} className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-6 md:grid md:grid-cols-2 md:gap-12 pb-12 md:pb-0">
                        {testimonials.map((t, i) => (
                            <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group p-10 md:p-16 rounded-[3rem] md:rounded-[5rem] bg-[#0A1520]/40 border border-cyan-900/10 hover:border-cyan-800/30 transition-all duration-700 shadow-xl flex flex-col items-center md:items-start">
                                <div className="relative w-24 h-24 mb-10 rounded-full overflow-hidden border-2 border-[#14B8A6]/30 group-hover:scale-110 transition-all duration-700 p-1 bg-[#0A1520]">
                                     <Image src={t.img} alt={t.name} fill className="object-cover rounded-full" />
                                </div>
                                <p className="text-2xl md:text-3xl font-serif italic text-cyan-50/90 leading-relaxed mb-10 text-center md:text-left font-black">&quot;{t.text}&quot;</p>
                                <div>
                                    <h4 className="text-[#14B8A6] font-black text-sm uppercase tracking-[0.2em]">{t.name}</h4>
                                    <p className="text-cyan-100/30 text-[10px] uppercase tracking-widest mt-2">{t.loc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="mt-8 md:hidden">
                        <div className="w-full h-[1px] bg-cyan-900/20 rounded-full overflow-hidden">
                            <div className="h-full bg-[#14B8A6] transition-all duration-300" style={{ width: `${scrolled.voices || 0}%` }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-32 bg-[#040A10] border-y border-cyan-900/20">
                <div className="container mx-auto px-6 max-w-5xl text-center md:text-left">
                    ...
                    <div onScroll={handleScroll('learn')} className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-8 md:grid md:grid-cols-2 pb-12 md:pb-0">
                        {phases.map((p, i) => (
                            <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group bg-[#0A1520]/30 rounded-[3rem] overflow-hidden border border-cyan-900/40 shadow-2xl hover:shadow-cyan-900/20 transition-all duration-700 flex flex-col h-full">
                    ...
                    <div className="mt-8 md:hidden">
                        <div className="w-full h-[1px] bg-cyan-900/20 rounded-full overflow-hidden">
                            <div className="h-full bg-[#14B8A6] transition-all duration-300" style={{ width: `${scrolled.learn || 0}%` }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-32 bg-[#060D14] border-t border-cyan-900/10 text-center md:text-left">
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-20 gap-8">
                        <div>
                             <h2 className="text-4xl md:text-6xl font-serif font-black text-white italic mb-6 tracking-tighter">Prepare-se para o <span className="text-[#14B8A6]">Extraordinário.</span></h2>
                             <p className="text-cyan-50/60 text-lg md:text-xl font-serif italic max-w-2xl mx-auto md:mx-0">Bônus exclusivos para quem decide hoje transformar sua realidade.</p>
                        </div>
                        <div className="inline-block px-10 py-6 rounded-full bg-cyan-950/20 border border-cyan-900/30 text-[#14B8A6] font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">Oferta de Lançamento</div>
                    </div>
                    ...
                    <div onScroll={handleScroll('bonuses')} className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-6 md:grid md:grid-cols-3 md:gap-12 pb-12 md:pb-0">
                        {bonuses.map((b, i) => (
                            <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group p-10 md:p-12 rounded-[2.5rem] md:rounded-[4rem] bg-[#040A10]/40 border border-cyan-900/10 hover:border-cyan-800/40 transition-all duration-700 h-full flex flex-col">
                                <div className="text-cyan-200/20 text-5xl font-black mb-8">0{i+1}</div>
                                <h3 className="text-2xl md:text-3xl font-serif font-black text-white mb-6 uppercase italic tracking-tighter">{b.title}</h3>
                                <p className="text-cyan-50/60 text-lg mb-8 leading-relaxed flex-1">{b.desc}</p>
                                <div className="text-[#14B8A6] font-black text-sm uppercase tracking-widest pt-8 border-t border-cyan-900/10">Valor: {b.value}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="mt-8 md:hidden">
                        <div className="w-full h-[1px] bg-cyan-900/20 rounded-full overflow-hidden">
                            <div className="h-full bg-[#14B8A6] transition-all duration-300" style={{ width: `${scrolled.bonuses || 0}%` }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="offer" className="py-12 md:py-28 bg-[#040A10]">
                <div className="container mx-auto px-6 text-center max-w-5xl">
                    <div className="mb-20 space-y-8">
                         <span className="inline-block py-2 px-8 rounded-full bg-[#14B8A6]/10 border border-[#14B8A6]/20 text-[#14B8A6] font-black tracking-[0.3em] text-[10px] uppercase shadow-sm">Acesso Imediato • 100% Digital</span>
                         <h2 className="text-4xl md:text-[80px] font-serif font-black text-white italic tracking-tighter leading-none">SUA JORNADA <br/> <span className="text-[#14B8A6] underline decoration-cyan-100 underline-offset-[10px] md:underline-offset-[20px]">COMEÇA AGORA.</span></h2>
                    </div>
                    
                    <div className="relative">
                        <div className="absolute inset-0 bg-[#0E3048] rounded-[5rem] -rotate-1 scale-105 -z-10 opacity-20" />
                        <div className="bg-[#0D2030]/40 rounded-[4rem] md:rounded-[6rem] p-10 md:p-16 border-8 border-cyan-950 shadow-4xl relative overflow-hidden">
                            ...
                            <div className="grid md:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="space-y-12 text-center">
                                    ...
                                    <button onClick={() => document.getElementById('offer')?.scrollIntoView({ behavior: 'smooth' })} className="w-full py-10 rounded-full bg-[#14B8A6] text-white font-black text-2xl md:text-3xl hover:bg-teal-400 hover:scale-[1.05] transition-all shadow-3xl uppercase tracking-[0.2em] leading-none">
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center text-left">
                        ...
                        <div className="space-y-12">
                             <div className="mb-8">
                                <span className="inline-block py-2 px-8 rounded-full bg-[#14B8A6]/10 border border-[#14B8A6]/20 text-[#14B8A6] font-black tracking-[0.5em] text-[10px] uppercase shadow-sm">A Criadora</span>
                             </div>
                             ...
                             <p className="text-lg md:text-xl text-cyan-50/80 font-serif italic leading-relaxed">
                                Elisa Clark dedicou mais de 5 anos pesquisando haloterapia, aromaterapia e produção artesanal. O <strong className="text-[#14B8A6] font-black">Método Essência Ativa BR</strong> é o resultado dessa jornada: um guia prático para você criar sais de banho terapêuticos com ingredientes brasileiros e transformar isso em renda real.
                             </p>
                             <div className="text-[#14B8A6] font-serif italic text-3xl font-black">— Elisa Clark</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-[#040A10] border-y border-cyan-900/20 text-center">
                <div className="container mx-auto px-6 max-w-3xl">
                    <div className="relative w-48 h-48 mx-auto mb-12 group">
                        <div className="absolute inset-0 bg-[#14B8A6]/10 rounded-full blur-3xl group-hover:bg-[#14B8A6]/20 transition-all duration-1000" />
                ...
                <div className="container mx-auto px-6 max-w-4xl text-left">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { q: "Como recebo o acesso ao Método?", a: "O acesso é imediato! Assim que o seu pagamento for aprovado, você receberá um e e-mail com o link para baixar o Ebook Completo e todos os Bônus diretamente no seu celular, tablet ou computador." },
                            ...
                            <div key={i} className="bg-[#0D2030]/30 border border-cyan-900/20 rounded-[2.5rem] overflow-hidden shadow-sm text-center md:text-left">
                                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full py-3 px-6 md:py-6 md:px-10 flex justify-between items-center text-left hover:bg-cyan-950/40 transition-colors">
                                ...
                                {openFaq === i && (
                                    <div className="p-6 md:p-10 pt-0 text-cyan-50/70 font-serif italic leading-relaxed border-t border-cyan-900/10 mt-[-1px]">
                                        {faq.a}
                                    </div>
                                )}
                            </div>
            ...
            {/* 13. FOOTER (Zen Neural Branding) */}
            <footer className="py-20 md:py-32 bg-[#020508] text-center border-t border-cyan-900/10">
                 <div className="container mx-auto px-6">
                    <div className="flex flex-col items-center gap-6 md:gap-12">
                        <div className="inline-block py-2 px-4 md:px-8 rounded-full bg-[#14B8A6]/10 border border-[#14B8A6]/20 text-[#E8D8B0] font-black tracking-[0.05em] md:tracking-[0.5rem] text-[7.5px] md:text-[10px] uppercase font-sans whitespace-nowrap">Sommer&apos;s Store Ltda - Todos os Direitos Reservados.</div>
                        <div className="mt-8 opacity-40">
                             <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-[10px] md:text-[12px] uppercase tracking-[0.3em] text-[#14B8A6] font-black">
                        ...
                        <div className="mt-12 text-[9px] uppercase tracking-[0.5em] text-cyan-200/10 font-black">
                            Zen Neural Atomic Edition v3.0
                        </div>
                    </div>
                 </div>
            </footer>
