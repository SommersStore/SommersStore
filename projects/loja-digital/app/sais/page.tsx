...
export default function ZenDarkV3() {
    ...
    const phases = [
        { title: "Fase 01: Conhecendo os Sais", desc: "Sal Marinho, Himalaia, Epsom e Negro — qual usar, quando usar e por quê.", img: "/sais/assets/conhecendo-os-sais.png" },
        { title: "Fase 02: Óleos Essenciais & Ervas", desc: "Lavanda, alecrim, camomila, eucalipto — como criar blends terapêuticos que encantam.", img: "/sais/assets/oleos-3.png" },
        { title: "Fase 03: Embalagem & Valor Percebido", desc: "Rótulos, sachês e apresentação que transformam seu produto artesanal em presente de luxo.", img: "/sais/assets/embalagem-e-valor.png" },
        { title: "Fase 04: Precificação & Primeiras Vendas", desc: "Como lucrar 200-400% vendendo para amigas, feiras, Instagram e WhatsApp.", img: "/sais/assets/precificacao-e-vendas-v3.png" },
        { title: "Fase 05: Escale Seu Negócio", desc: "De escalda-pés caseiro a kits premium para spas e lojas — cresça no seu ritmo.", img: "/sais/assets/escalar.jpg" },
        { title: "Fase 06: Como Fidelizar Seus Primeiros Clientes", desc: "Estratégias de pós-venda, mimos e atendimento que transformam uma compra em um hábito.", img: "/sais/assets/fidelizar-cliente-v3.png" }
    ];

    const bonuses = [
        { title: "10 Receitas de Blends Prontos para Vender", value: "R$ 197", desc: "Relaxamento, energia, pós-treino, detox e sono — receitas testadas com proporções exatas.", img: "/sais/assets/bonus-1-v2.png" },
        { title: "Lista de Fornecedores Brasileiros", value: "R$ 97", desc: "Onde comprar sal marinho, sal do Himalaia, óleos essenciais e ervas com os melhores preços.", img: "/sais/assets/bonus-2.png" },
        { title: "Kit de Posts + Script de Vendas WhatsApp", value: "R$ 147", desc: "Textos prontos para Instagram e WhatsApp que convertem curiosas em clientes fiéis.", img: "/sais/assets/bonus-3.png" }
    ];

    const testimonials = [
        { name: "Cristiane, 31a", loc: "SÃO PAULO/SP", text: "Comecei com R$ 150 investidos e muita insegurança. Três meses depois, já tinha vendido mais de 200 unidades e conseguido minha primeira renda de R$ 2.800 em um mês. Isso não tem preço!", img: "/sais/assets/Cristiane.jpg" },
        { name: "Patrícia, 26a", loc: "BELO HORIZONTE/MG", text: "Era professora estressada sem tempo. Comecei fazendo para uso próprio. Quando amigas experimentaram e pediram para comprar, percebi que tinha algo nas mãos. Hoje minha renda extra com os sais paga as contas da casa.", img: "/sais/assets/patricia.jpg" },
        { name: "Amanda, 45a", loc: "CURITIBA/PR", text: "Nunca tinha vendido nada e nem tinha Instagram. Segui o método e comecei vendendo para vizinhas. Hoje atendo pela internet e já fiz mais de 500 vendas. O método mudou minha vida e minha relação com o trabalho.", img: "/sais/assets/amanda.jpg" },
        { name: "Carolina, 38a", loc: "RECIFE/PE", text: "Estava desempregada e desesperada. Comecei com R$ 100 emprestados. Dois meses depois, já tinha faturado R$ 1.500. Hoje meus sais são minha principal fonte de renda. Recuperei minha autoestima.", img: "/sais/assets/carolina.jpg" }
    ];
    ...
    return (
        <div className="min-h-screen bg-[#0A0D0C] text-[#F5F5DC] font-sans selection:bg-[#043927] selection:text-[#F5F5DC] overflow-x-hidden">
            ...
            <div className="fixed bottom-6 right-6 z-50 opacity-50 pointer-events-none">
                <Image src="/sais/assets/sss-logo.png" alt="SsS" width={48} height={48} className="drop-shadow-lg" />
            </div>
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-12 md:py-24">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center max-w-6xl">
                    ...
                    <div className="relative aspect-video max-w-4xl mx-auto rounded-[3rem] md:rounded-[5rem] overflow-hidden border border-[#C5A059]/40 shadow-[0_0_30px_rgba(197,160,89,0.1)] mb-12 md:mb-20 bg-[#0a2a22]/30">
                         <Image src="/sais/assets/5.png" alt="Hero Asset" fill className="object-cover opacity-80" />
                    </div>
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center text-left">
                        ...
                        <div className="relative aspect-[3/4] rounded-[3rem] md:rounded-[5rem] overflow-hidden border border-[#C5A059]/40 shadow-[0_0_30px_rgba(197,160,89,0.1)] md:grayscale-0 md:saturate-[1.3] transition-all duration-1000">
                             <Image src="/sais/assets/zen-pain-3.png" alt="Pain Visual" fill className="object-cover" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 text-center max-w-5xl">
                    ...
                    <div className="bg-[#0a2a22]/30 rounded-[3rem] md:rounded-[6rem] px-6 py-10 md:px-24 md:py-20 border border-[#C5A059]/40 text-center relative overflow-hidden group shadow-[0_0_40px_rgba(197,160,89,0.15)]">
                        ...
                        <div className="absolute inset-0 opacity-40 group-hover:opacity-60 transition-all duration-1000">
                             ...
                             <Image src="/sais/assets/zen-method-2.jpg" alt="Alchemy Background" fill className="object-cover" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-28 bg-[#030d0a] border-y border-emerald-900/20">
                <div className="container mx-auto px-6 max-w-5xl text-center">
                    ...
                    <div className="relative group/carousel">
                        ...
                        {[
                            { t: "Seus primeiros 10 blends exclusivos: do relaxamento profundo ao detox mineral.", img: "/sais/assets/10-blends.png" },
                            { t: "O banheiro transformado em um spa particular de alto padrão para seu autocuidado.", img: "/sais/assets/banho-spa.jpg" },
                            { t: "Suas primeiras vendas realizadas com margens de lucro entre 200% e 400%.", img: "/sais/assets/prim-vendas.jpg" },
                            { t: "Domínio das embalagens e rótulos de luxo que elevam seu valor percebido.", img: "/sais/assets/embal-rot-luxo.jpg" },
                            { t: "Primeiro catálogo montado e parcerias iniciadas com spas e lojas de bem-estar.", img: "/sais/assets/catalogo.jpg" }
                        ].map((item, i) => (
                        ...
                        {phases.map((p, i) => (
                            <div key={i} className="min-w-[85vw] md:min-w-0 snap-center group bg-[#0a2a22]/30 rounded-[3rem] overflow-hidden border border-[#043927] shadow-inner transition-all duration-700 flex flex-col h-full">
                                <div className="relative h-64 w-full">
                                    <Image src={p.img || `/sais/assets/${i+1}.png`} alt={p.title} fill className="object-cover md:grayscale md:group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-110" />
                                </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="space-y-12 text-center">
                                    <div className="relative aspect-square w-full rounded-full border-8 border-[#0a2a22] shadow-3xl overflow-hidden bg-emerald-950">
                                        <Image src="/sais/assets/circulo-preco-v2.png" alt="Product" fill className="object-cover saturate-[0.85] opacity-90 md:saturate-125 md:opacity-100 transition-all" />
                                    </div>
                ...
                <div className="container mx-auto px-6 max-w-[72rem]">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-20 items-center text-left">
                        <div className="relative aspect-[3/4] rounded-[4rem] md:rounded-[6rem] overflow-hidden border border-[#043927] shadow-inner saturate-125 transition-all duration-1000">
                             <Image src="/sais/assets/elisa-clark-v3.png" alt="Elisa Clark" fill className="object-cover" />
                        </div>
            ...
            <section className="py-12 md:py-28 bg-[#030d0a] border-y border-emerald-900/20 text-center">
                <div className="container mx-auto px-6 max-w-3xl">
                    <div className="relative w-48 h-48 mx-auto mb-12 group">
                        ...
                        <Image src="/sais/assets/premium-seal.png" alt="Selo de Garantia Premium" width={200} height={200} className="relative z-10 drop-shadow-[0_20px_50px_rgba(197,160,89,0.3)] group-hover:scale-110 transition-transform duration-700" />
                    </div>
